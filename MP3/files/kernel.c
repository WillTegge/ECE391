...
void entry(unsigned long magic, unsigned long addr) {
    ...
    printf("Initializing Filesystem/memory\n");
    //mod_addr->mod_start
    module_t* mod = (module_t*)mbi->mods_addr;    
    filesystem_init((module_t*)mod->mod_start);
    ...
    // Do we need to initialize the terminal here or no???
    // TA said no initialization for the terminal here. only keyboard
    // terminal_init();
